...
# configure_forcings + process_forcings (mirrors the CrocoGallery tutorial)
...
# Chlorophyll — use real SeaWiFS if available, otherwise synthetic
...
# Runoff mapping — use T62 ESMF mesh from NYF inputdata as the ROF mesh
t62_mesh = DIN_LOC_ROOT / "share/meshes/T62_040121_ESMFmesh.nc"
gen_rof_maps(
    rof_mesh_path=t62_mesh,
